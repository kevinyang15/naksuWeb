<template>
    <div>
        <nuxt-layout name="layout-eleven">
            ...
            <section class="tp-privacy-area pt-120 pb-120" style="background-color: #EAECF3;">
                <div class="container">
                            ...
                            <div class="tp-privacy-box">
                                ...
                                <div class="tp-privacy-content">
                                    ...
                                    <ul>
                                        ...
                                        <li>Cookies and Tracking Data: Data collected through cookies, web beacons, and
                                            similar technologies.</li>
                                    </ul>
                                </div>
                                <div class="tp-privacy-content">
                                ...
                                <div class="tp-privacy-content">
                                    ...
                                    <p>We do not sell, trade, or otherwise transfer your personal information to outside
                                        parties. We may share your information with trusted third parties who assist us
                                        in operating our website and services, as long as they agree to keep this
                                        information confidential. </p>
                                </div>
                                <div class="tp-privacy-content">
                                    <h4 class="tp-privacy-content-title">Data Security</h4>
                                    <p>We implement a variety of security measures to protect your personal information.
                                        We use encryption, secure socket layer technology, and regular security audits
                                        to safeguard your data.</p>
                                </div>
                                <div class="tp-privacy-content">
                                    <h4 class="tp-privacy-content-title">Cookies and Tracking Technologies</h4>
                                    <p>We use cookies and similar tracking technologies to enhance your user experience.
                                        You can choose to disable cookies through your browser settings; however, this
                                        may affect your ability to use our website.</p>
                                </div>
                                <div class="tp-privacy-content">
                                    <h4 class="tp-privacy-content-title">Your Choices</h4>
                                    <p>You can choose not to provide certain information; however, this may limit your
                                        access to some features of our website.</p>
                                </div>
                                <div class="tp-privacy-content">
                                    <h4 class="tp-privacy-content-title">Changes to this Privacy Policy</h4>
                                    <p>We reserve the right to update or change this Privacy Policy at any time. When we
                                        do, we will revise the {"Effective Date"} at the beginning of this policy. We
                                ...
                                <div class="tp-privacy-content-bottom mt-30">
                                    <p>Last updated on October 15, 2023. ThemePure reserves the right to change or
                                        modify the above contents at any time without any prior notice.</p>
                                </div>
                            </div>
                        </div>
                    </div>
