    ...
    <div>
        <nuxt-layout name="layout-eleven">
            ...
            <template v-if="course">
                ...
                <course-details-breadcrumb :course="course" />
                <!-- breadcrumb area end -->

                <!-- course details area start -->
                <course-details-area :course="course" />
            ...
            <div v-if="!course" class="text-center mt-100 mb-80">
...
useSeoMeta({ title: "Course Details - Acadia" });
