import {type IMenu, type IMenuDT2 } from "@/types/menu-d-t";
...
const menu_data:IMenu[] = [
    {
	 ...
	 },
	 {
		...
		link:'#',
		dropdown_menus:[
			{id:1,title:"Muay Thai", link: "#" },
			{id:1,title:"Muay Thai Kids", link: "#" },
			{id:2,title:"Boxeo", link: "#" },
			{id:3,title:"Acondicionamiento Físico", link: "#" },
			{id:4,title:"Funcional", link: "#" },
			{id:5,title:"Crossfit", link: "#" },
			{id:6,title:"Calistenia", link: "#" },
			{id:7,title:"Sibpalki", link: "#" },
		]
	 },
	 {
		id:4,
		title:'Planes / Membresias',
		link:'#',
		dropdown_menus:[
			{id:1,title:"Plan 1", link: "#" },
			{id:2,title:"Plan 2", link: "#" },
			{id:3,title:"Plan 3", link: "#" },
		]
	 },
	 {
		id:5,
		...
		course_dropdown:[
			...
			},
			{
				...
				dropdown_menus:[
					...
					{ id: 5, title: "Create Course", link: "/create-new-course", new: true },
				]
			}
		]
	},
		...
		dashboard_dropdown:[
			{
				...
				dropdown_menus:[
					...
					{ id: 6, title: "My Quiz Attempts", link: "/dashboard/instructor-quiz" },
