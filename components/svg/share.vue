<template>
    <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            :stroke="clr" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path
        ...
        <path
            ...
            :stroke="clr" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M4.72656 8.98157L9.28 11.5686" :stroke="clr" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
        <path d="M9.27333 4.4314L4.72656 7.01841" :stroke="clr" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
    </svg>
</template>
