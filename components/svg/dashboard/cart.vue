<template>
    <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M5.08297 12.2L3.01325 2.21194C2.8375 1.49968 2.20585 1 1.48122 1H0.740234" stroke="currentColor"
        ...
        <ellipse cx="7.05938" cy="15.8" rx="1.18438" ry="1.2" stroke="currentColor" stroke-width="1.5" />
        <ellipse cx="12.5809" cy="15.8" rx="1.18438" ry="1.2" stroke="currentColor" stroke-width="1.5" />
    </svg>
</template>