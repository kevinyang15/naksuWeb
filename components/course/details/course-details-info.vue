<template>
    <div id="info">
      ...
      <div class="tp-course-details-2-text mb-60">
        <div :class="['content', { show: showMore }]">
          <p>
            This course is aimed at people interested in UI/UX Design. We’ll start from the very <br />
          ...
          <p>
            First, we will go over the differences between UX and UI Design. We will look at what our <br />
            brief for this real-world project is, then we will learn about low-fidelity wireframes and how <br />
            to make use of existing UI design kits.
          </p>
        </div>
        <a @click="toggleShowMore" class="tp-course-details-showmore show-more-button">
          <span class="svg-icon" v-if="showMore">
             <svg-minus clr="#3C66F9"/>
          </span>
          <span class="svg-icon" v-else>
             <svg-plus clr="#3C66F9"/>
          </span>
      ...
      <div class="tp-course-details-2-list">
        ...
        <p>
          ...
          also free media like aerial video shots, background music, fonts, and more.
        </p>
      </div>
    </div>
  </template>
