<template>
    <div class="profile__address">
        <div class="row">
            <div v-for="(address, index) in addressData" :key="index" class="col-md-6">
                <div class="profile__address-item d-sm-flex align-items-start">
                    <div class="profile__address-icon">
                        <span v-html="address.icon"></span>
                    </div>
                    <div class="profile__address-content">
                        <h3 class="profile__address-title">{{ address.type }}</h3>
