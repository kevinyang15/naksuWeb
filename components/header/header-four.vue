                ...
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-6 col-6">
                        <div class="tp-header-5-logo tp-header-logo">
                            <nuxt-link href="/">
                                <img class="logo-1" src="/images/logo/logoparchekaian.png" alt="logo">
                                <img class="logo-2" src="/images/logo/logoparchekaian.png" alt="logo">
                            </nuxt-link>
                        </div>
                    </div>
                    <div class="col-xl-8 d-none d-xl-block">
                        <div class="main-menu" style="padding-left: 80px;">
